...
public class HibernateTimeGroupDAO implements TimeGroupDAO {
    ...
    public int update(TimeGroup _obj) throws DataAccessException {
    ...
    public TimeGroup getById(String _id) throws DataAccessException {
        ...
        try {
            Session session = sessionFactory.getCurrentSession();
            return (TimeGroup) session.get(TimeGroup.class,_id);
        } catch (Exception e) {
    ...
    public List<TimeGroup> getAll() throws DataAccessException {
        ...
        try {
            Session session = sessionFactory.getCurrentSession();
            List<TimeGroup> result = session.createCriteria(TimeGroup.class).list();
            return result;
        } catch (Exception e) {
