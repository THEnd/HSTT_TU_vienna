...
public class HibernateResourceDAO implements ResourceDAO {
    ...
    public int update(Resource _obj) throws DataAccessException {
    ...
    public Resource getById(String _id) throws DataAccessException {
        ...
        try {
            Session session = sessionFactory.getCurrentSession();
            return (Resource) session.get(Resource.class,_id);
        } catch (Exception e) {
    ...
    public List<Resource> getAll() throws DataAccessException {
        ...
        try {
            Session session = sessionFactory.getCurrentSession();
            List<Resource> result = session.createCriteria(Resource.class).list();
            return result;
        } catch (Exception e) {
